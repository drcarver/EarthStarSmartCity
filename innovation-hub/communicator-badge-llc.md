...
description: Original full specification for the Communicator Badge LLC, including Core and Health variants with expanded sensor suite, companion CGM-style continuous glucose monitor patch, future iteration roadmap, and diseases/problems that can be screened or early-detected (February 2026 baseline).
...
The **Communicator Badge LLC** designs, manufactures, and deploys the flagship Genesis wearable device family. The badge serves as a personal interface, safety device, positioning beacon, and continuous health monitor. The **Core** variant provides essential communication and basic vitals, while the **Health** variant adds an expanded sensor suite for proactive screening of metabolic, cardiovascular, respiratory, stress, and infectious conditions.

A companion **CGM-style continuous glucose monitor patch** delivers precise interstitial glucose tracking and emerging metabolic biomarkers, transmitting data to the badge for local processing, alerts, and **[digital twins](docs/digital-twins.md)** integration.

## Product Family

1. **Communicator Badge Core**  
   - General-purpose wearable for voice, positioning, and basic vitals  
   - Retail price: $89–$149

2. **Communicator Badge Health**  
   - Full sensor suite for continuous metabolic, cardiac, respiratory, stress, and inflammation monitoring  
   - Retail price: $149–$299

3. **CGM-Style Continuous Monitor Patch**  
   - Minimally invasive adhesive patch (upper arm/abdomen) for glucose + additional metabolic markers  
   - 14-day wear duration, waterproof  
...
## CGM-Style Continuous Monitor Patch
...
- **Integration**: Glucose trends + alerts → badge displays/haptics/voice; optional sync to **[digital twins](docs/digital-twins.md)** and TerraWell
...
- **2036–2040** — Non-invasive optical hemoglobin estimate; integrated microneedle array for electrolytes/inflammation
