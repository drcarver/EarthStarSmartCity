---
layout: default
title: ISO/TC 268 – Sustainable Cities and Communities
description: Detailed overview of ISO/TC 268 standards as applied in the Genesis Network, including key standards, compliance mechanisms, sensor integration, and smart city KPIs.
...
**ISO/TC 268** is the International Organization for Standardization technical committee responsible for developing standards for **sustainable cities and communities**. It provides frameworks, indicators, and management systems that enable cities, regions, and organizations to measure, report, and improve sustainability performance across economic, social, environmental, and governance dimensions.

In the Genesis Network, **ISO/TC 268** serves as the primary reference for smart city interoperability, performance monitoring, and regulatory alignment. All hubs, towers, and distributed mini-hubs are designed to comply with its core standards, ensuring compatibility with global sustainable development goals (SDGs), investor requirements, and potential future municipal adoption.

## Key ISO/TC 268 Standards Implemented
...
The following table lists sensors that directly support **ISO/TC 268** KPIs, with hyperlinks to detailed entries.
...
Compliance with **ISO/TC 268** enables:
- Eligibility for international sustainability grants and carbon markets  
- Credibility with sovereign partners during global open invitation phase  
- Interoperability with existing smart city initiatives  
