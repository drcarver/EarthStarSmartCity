---
layout: default
title: Kits Catalog – Genesis Network Components
description: Complete catalog of all flat-pack kits used in the Genesis Network, including manufacturing, inputs, materials, costs, revenues, and viability notes.
license: Creative Commons Attribution 4.0 International (CC BY 4.0)
theme: minimal
---

# Kits Catalog  
**Genesis Network – All Flat-Pack Kits**  
**Last Updated: January 21, 2026**

All kits are manufactured in **tile factory pods** using **waste-derived toughened ceramics** (70–95% from C&D slag, rice husk ash silica, farm residues, ELFM/brownfield slag). They are designed for rapid self-replication, mobility, and 95–99% resource closure. Costs reflect mature-phase economies (automation, pre-supply); revenues include premium sales, upgrades, and credit sharing.
...
- **[Agroforestry Expansion Kit](/components/kits/agroforestry-expansion-kit.md)**  
  ...
  - **Materials**: Ceramics + sensors  
  - **Cost**: $50–100K/kit  
  - **Revenue**: $150–350K/year (fruits/nuts + credits)  
  - **Notes**: Maximizes sequestration and premium output  

- **[Restoration & Blue-Green Carbon Kit](roadmaps/50-year-roadmap.md)**  
  - **Description**: Wetland, mangrove, kelp, oyster restoration modules  
  - **Inputs**: Waste/slag  
  - **Materials**: Ceramics + planting tools  
  - **Cost**: $60–120K/kit  
...
- **[Education/Telepresence Kit](/components/kits/viability-enhancements.md)**  
  ...
  - **Cost**: $50–100K/kit  
  - **Revenue**: $100–200K/year (tourism/training)  
  - **Notes**: Reduces oversight burden  
...
- **[Security Smart City Kit](components/kits/Security-Smart-City-Kit.md)**  
  ...
  - **Materials**: Ceramics + embeds  
  - **Cost**: $30–60K/kit  
  - **Revenue**: $100–200K/year (compliance + grants)  
  - **Notes**: Enables sustainable building codes & funding  

**Recalculated Network Impact (Mature Phase, 2035+)**  
- **Total CAPEX Reduction**: 20% via kit standardization and waste inputs  
- **Revenue Uplift**: 30% from premium sales, upgrades, and credit monetization  
- **Annual Kit Revenue Contribution**: $5–15B (network-wide)  

All kits are received from **tile factory pods** and are fully compatible with **ceramic construction standards**.  
